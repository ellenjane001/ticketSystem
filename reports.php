    ...
    <div class="view">
        ...
        <div class="wrapper">
            ...
            <div id="filterSection" class="filter items item1">
                ...
                <br>
                <a href="#" style="text-decoration: underline; padding: 0px;" class="<?= $_SESSION['accountInfo']['username'] ?> " onclick="exportToCSV(this)"> <img class="wrapper-image" src="srcs/icons8-export-csv-24.png"> Export to CSV</a>
                <br>
